...
1. Моделирование случайной величины: написать первую часть программы – «розыгрыш» значений случайной величины. Пользователь с клавиатуры вводит количество повторений экспериментов и параметры задачи.
